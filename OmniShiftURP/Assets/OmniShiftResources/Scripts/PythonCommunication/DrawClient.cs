...
public class DrawClient : Client
{
    private readonly ConcurrentQueue<Action> runOnMainThread = new ConcurrentQueue<Action>();
    private DrawReceiver receiver;


    [Header("Update Actions")]
    public DrawDataHandler dataHandler;
    ...
    public override void StartCommunication()
    {
        ...
        receiver = new DrawReceiver();
        receiver.Start((DrawData d) => runOnMainThread.Enqueue(() =>
        {
