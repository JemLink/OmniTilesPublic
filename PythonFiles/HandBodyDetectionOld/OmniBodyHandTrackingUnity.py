...
## new version where the communication is put outside of the hands

## Fast cam acquisition

## ToDo
## - need to change unity communication position (it is currently in the hands loop)
## - loop over unity first
## - create unity communication that can send picture
    ...
    try:
        ...
        while(continue_recording):
            try:
                ...
                ## unity communication
                ## I am not sure of the position of this function yet...
                message = socket.recv()
