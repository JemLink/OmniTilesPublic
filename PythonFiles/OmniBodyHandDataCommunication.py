...
K=np.array([[388.64730611958856, 0.0, 449.47094620687164], [0.0, 388.91362511113493, 343.0733743508866], [0.0, 0.0, 1.0]])
D=np.array([[-0.06028128941954454], [-0.0017907871903818239], [-0.08044438350110109], [0.101569106782424]])
...
def createImageTrackbar():
    ...
    cv2.createTrackbar("roi_x", "Image Track Bar", 584, 1000, trackChanged)
    cv2.createTrackbar("roi_y", "Image Track Bar", 1227, 1500, trackChanged)
                ...
                while(continue_recording):
                    try:
                        ...
                        if image_result.IsIncomplete():
                            ...
                            # show image in gray
                            cv2.imshow("GrayScaleImage", image_rgb)
